      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">{{ name }} | 芭娜娜CEO</p>
          </div>
        </div>
        <div class="fr" />
      </div>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第1期“芭娜娜大讲堂”互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第2期“芭娜娜大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第3期“芭娜娜大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
...
export default {
  ...
  data() {
    return {
      defaultImg: require('@/assets/common/bitbug.png')
    }
  },
  computed: {
    ...mapGetters([
