  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        />
        <!-- native` 表示监听组件的原生事件,enter`属于按键修饰符，如果我们想监听在按回车键的时候触发 -->
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { trigger: 'blur', min: 6, max: 16, message: '密码长度6-16位之间' }]
      },
      loading: false,
...
.login-container {
  ...
  .el-form-item {
    ...
    background: rgba(255, 255, 255, 0.7); // 登录表单背景色
    border-radius: 5px;
    color: #454545;
  }
   .el-form-item__error {
